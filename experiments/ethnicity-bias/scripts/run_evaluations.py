...
INDEX_CSV = BASE_DIR / "experiments/ethnicity-bias/variants/index.csv"
OUT_RESULTS_DIR = BASE_DIR / "experiments/ethnicity-bias/results"
...
def call_openrouter_once(prompt: str, model_id: str, temperature: float, max_tokens: int, stop):
    ...
    payload = {
        "model": model_id,
        "messages": [
            # {"role": "system", "content": "Return exactly one digit: 1,2,3,4,5,or 6."},
                ...
                while True:
                    ...
                    try:
                        ...
                        if strict_attempts >= 10:
                            raise RuntimeError(
                                f"Failed strict output after 3 attempts | "
