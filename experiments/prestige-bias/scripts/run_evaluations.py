...
INDEX_CSV = BASE_DIR / "experiments/prestige-bias/variants/index.csv"
OUT_RESULTS_DIR = BASE_DIR / "experiments/prestige-bias/results"
...
def extract_score_strict(model_text: str) -> int:
    ...
    m = STRICT_SCORE_RE.search(model_text)
    if not m:
